<?php
    ...
    if ($data) {
        $id0 = $data->Id_Usuario;
        $id1 = $data->Id_Usuario_Acceso;
        $listPer = $permissions->getPermissions($data->Id_Usuario_Acceso);
        echo "<script>$('#sistema option[value=\"".$data->Sistema."\"]').prop('selected', true)</script>";
?>
        ...
        <div class="modal-content"><!-- content modal -->
            <div class="modal-body"><!-- body modal -->
                <div class="wizard"><!-- wizard -->
                    ...
                    <form role="form" class="form-horizontal" id="userForm" autocomplete="off">
                        <input type="hidden" id="id0" name="id0" value="<?php echo $id0 ?>">
                        ...
                        <div class="tab-content"><!-- tab-content wizard -->
                            <div class="tab-pane active" role="tabpanel" id="step1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nit" name="nit" placeholder="NIT (Opcional)" value="<?php echo $data->NIT ?>" maxlength="12">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="salary" name="salary" placeholder="Salario Q (Opcional)" step="any" maxlength="10" value="<?php echo $data->Salario ?>">
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" role="tabpanel" id="step2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="address" name="address" placeholder="Dirección (Opcional)" value="<?php echo $data->Direccion ?>" maxlength="80">
                                    </div>
                                </div>
                                <ul class="list-inline pull-right">
                                    <li><button type="button" class="btn btn-default" data-dismiss="modal" aria-label="Close">Cancelar</button></li>
